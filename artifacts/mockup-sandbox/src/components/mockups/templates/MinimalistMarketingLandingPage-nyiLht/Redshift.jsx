    ...
    <div className="w-full h-full bg-[#EAE8E3] relative overflow-hidden flex flex-col justify-between p-10 font-['Inter']">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-10">
        <div className="relative w-full h-full flex items-center justify-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[60%] text-[#FF2B1A] font-['Archivo'] font-black text-[320px] leading-none tracking-[-0.04em] whitespace-nowrap mix-blend-multiply">
            GROWTH
          </div>
